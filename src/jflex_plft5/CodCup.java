...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Jan 26 00:53:41 BRST 2015
  */
public class CodCup extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\017\000\004\006\007\001\002\000\004\107\021\001" +
    "\002\000\004\107\020\001\002\000\004\002\017\001\002" +
    "\000\002\001\002\000\004\107\013\001\002\000\004\107" +
    "\012\001\002\000\004\002\uffff\001\002\000\004\002\001" +
    "\001\002\000\004\011\015\001\002\000\004\124\016\001" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\017\000\014\003\005\004\007\005\010\006\003\007" +
  ...
  public final java_cup.runtime.Symbol CUP$CodCup$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$CodCup$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // bloco ::= BEGIN lista_comando END PONTO 
            {
              Object RESULT =null;

              CUP$CodCup$result = parser.getSymbolFactory().newSymbol("bloco",1, ((java_cup.runtime.Symbol)CUP$CodCup$stack.elementAt(CUP$CodCup$top-3)), ((java_cup.runtime.Symbol)CUP$CodCup$stack.peek()), RESULT);
            }
          return CUP$CodCup$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // bloco ::= declaracao_proc_e_func PV 
            {
              Object RESULT =null;

              CUP$CodCup$result = parser.getSymbolFactory().newSymbol("bloco",1, ((java_cup.runtime.Symbol)CUP$CodCup$stack.elementAt(CUP$CodCup$top-1)), ((java_cup.runtime.Symbol)CUP$CodCup$stack.peek()), RESULT);
            }
          return CUP$CodCup$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // bloco ::= declaracao_variavel PV 
            {
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // bloco ::= declaracao_tipo PV 
            {
              Object RESULT =null;
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 0: // bloco ::= declaracao_constante PV 
            {
              Object RESULT =null;
